    ...
    document.getElementById('rungeKuttaForm').addEventListener('submit', function(event) {
        ...
        .then(result => {
            ...
            result.datos_iteraciones.forEach(iteracion => {
                ...
                row.insertCell(2).textContent = iteracion.k1;
                row.insertCell(3).textContent = iteracion.k2;
                row.insertCell(4).textContent = iteracion.k3;
                row.insertCell(5).textContent = iteracion.k4;
                row.insertCell(6).textContent = iteracion['Yi+1'];
                row.insertCell(7).textContent = iteracion.y_analitica;
                row.insertCell(8).textContent = iteracion.error;
            });
